...
function divider(nums, evens, odds) {
    for (var i = 0; i < nums.length; i++) {
        ...
        else if (nums[i] % 2 === 1) {                      //Correct, but not working in Jasmine
            odds.push(nums[i]);
        }
    }
...
var user2 = {
    name: 'bs McGinnis',
    email: 'tylermcginnis3@gmail.com',
    password: 'iLveJavaScript',
    username: 'infiniateoop'
};

var user3 = {
    name: 'b McGinnis',
    email: 'tylermcginnis@gmail.com',
    password: 'iLoveJavScript',
    username: 'infniateLoop'
};
